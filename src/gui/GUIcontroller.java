...
public class GUIcontroller {
    ...
    private void cellZSees() {
        ...
        cellDo.setText(
                "action   : " + allCells.get(0).getCellBrain().cellThinking() + "\n"
                + "direction: " + allCells.get(0).getIsLooking() + "\n"
                + "cell life: " + allCells.get(0).getLifeTime() + "\n"
                + "cell fat: " + allCells.get(0).getCellFat() + "\n");
